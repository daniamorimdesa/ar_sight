...
/// Displays instructions for capturing a scene scan.
///
/// A [HowToPage] explains how the user should move the device, what kind of
/// environment produces better AR tracking conditions, and how the captured
/// frames are processed by the diagnosis pipeline.
class HowToPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // Top app bar for the instructions screen.
      appBar: AppBar(
        backgroundColor: const Color(0xFFF8FAFC),
        elevation: 0,
      ...
      // Scrollable content with scanning guidance and environment tips.
      body: SafeArea(
        child: ListView(
          padding: const EdgeInsets.fromLTRB(16, 16, 16, 20),
          children: [
            // Introductory explanation with decorative ARSIGHT icon.
            Stack(
              children: [
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'The frames are sent to a server that evaluates scene '
                        'conditions and returns recommendations to improve AR '
                        'tracking stability.',
                ...
                // Rotated decorative icon placed beside the introduction text.
                Positioned(
                  right: -10,
                  top: 0,
            ...
            // User behavior guidelines for obtaining a stable scan.
            ...
            // Scene condition guidelines related to AR tracking quality.
...
/// Returns the default body text style used by the instructions page.
TextStyle _body({double opacity = 0.92}) {
